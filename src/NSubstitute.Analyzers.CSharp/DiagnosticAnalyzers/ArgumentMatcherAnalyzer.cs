...
namespace NSubstitute.Analyzers.CSharp.DiagnosticAnalyzers
{
    ...
    {
        private static ImmutableArray<ImmutableArray<Parent>> PossibleAncestorPaths { get; } = ImmutableArray.Create(
        ...
        protected override MatcherAnalyzer GetMatcher()
        {
            return new MyMatch(DiagnosticDescriptorsProvider);
        }

        internal class MyMatch : MatcherAnalyzer
        {
            protected override SyntaxNode FindEnclosingExpression(SyntaxNodeAnalysisContext syntaxNodeAnalysisContext,
                InvocationExpressionSyntax invocationExpression)
            {
                return GetEnclosingSyntaxNode(syntaxNodeAnalysisContext, invocationExpression);
            }

            protected override bool IsFollowedBySetupInvocation(SyntaxNodeAnalysisContext syntaxNodeContext,
            ...
            protected override bool IsPrecededByReceivedInvocation(SyntaxNodeAnalysisContext syntaxNodeContext,
                SyntaxNode invocationExpressionSyntax)
            {
            ...
            public MyMatch(IDiagnosticDescriptorsProvider diagnosticDescriptorsProvider) : base(diagnosticDescriptorsProvider)
            {
            }
        }
    }
