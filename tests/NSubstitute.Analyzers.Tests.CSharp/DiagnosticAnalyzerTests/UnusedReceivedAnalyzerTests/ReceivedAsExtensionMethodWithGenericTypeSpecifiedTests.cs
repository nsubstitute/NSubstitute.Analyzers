...
{
    public class ReceivedAsExtensionMethodWithGenericTypeSpecifiedTests : UnusedReceivedDiagnosticVerifier
    {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            substitute.Received<IFoo>(1).Bar();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var bar = substitute.Received<IFoo>(1).Bar;
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var bar = substitute.Received<IFoo>(1)[0];
        }
    }
}";
