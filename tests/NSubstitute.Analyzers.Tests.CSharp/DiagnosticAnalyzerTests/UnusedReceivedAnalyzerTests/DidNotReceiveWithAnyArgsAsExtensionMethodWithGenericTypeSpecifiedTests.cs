...
{
    public class DidNotReceiveWithAnyArgsAsExtensionMethodWithGenericTypeSpecifiedTests : UnusedReceivedDiagnosticVerifier
    {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.DidNotReceiveWithAnyArgs<IFoo>();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var bar = substitute.DidNotReceiveWithAnyArgs<IFoo>().Bar;
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var bar = substitute.DidNotReceiveWithAnyArgs<IFoo>()[0];
        }
    }
}";
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.DidNotReceiveWithAnyArgs<object>(1);
        }
    }
}";
            await VerifyDiagnostic(source);
