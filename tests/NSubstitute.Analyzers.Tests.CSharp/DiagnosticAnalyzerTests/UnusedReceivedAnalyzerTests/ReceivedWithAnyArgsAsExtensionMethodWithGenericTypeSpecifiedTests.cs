...
{
    public class ReceivedWithAnyArgsAsExtensionMethodWithGenericTypeSpecifiedTests : UnusedReceivedDiagnosticVerifier
    {
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.ReceivedWithAnyArgs<object>(1m);
        }
    }
}";
            await VerifyDiagnostic(source);
