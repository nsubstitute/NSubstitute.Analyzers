...
{
    public class ReturnsForAnyArgsAsExtensionMethodWithGenericTypeSpecifiedTests : NonVirtualSetupDiagnosticVerifier
    {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            returnValue.ReturnsForAnyArgs<int>(1);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute().ReturnsForAnyArgs<int>(1);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar(1, 2).ReturnsForAnyArgs<int>(1);
            substitute.Bar(1).ReturnsForAnyArgs<int>(1);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar<int>(1, 2).ReturnsForAnyArgs<int>(1);
            substitute.Bar(1).ReturnsForAnyArgs<int>(1);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute[1, 2].ReturnsForAnyArgs<int>(1);
            substitute[1].ReturnsForAnyArgs<int>(1);
        }
    }
}";
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.GetBar().ReturnsForAnyArgs<int>(1);
            substitute.GetFooBar().ReturnsForAnyArgs<int>(1);
        }
    }
