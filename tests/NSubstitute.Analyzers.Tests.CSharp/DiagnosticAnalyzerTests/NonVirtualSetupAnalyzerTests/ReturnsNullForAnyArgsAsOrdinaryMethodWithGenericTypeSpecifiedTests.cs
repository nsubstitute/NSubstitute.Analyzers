...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar());
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(Foo.Bar());
        }
    }
}";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(18, 61)
                }
            };
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(returnValue);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute());
        }
    }
}";
            await VerifyDiagnostic(source);
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(24, 61)
                }
            };
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar<int>());
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute[1]);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        ...
        {
            Foo substitute = null;
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar(), null);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar);
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.FooBar);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar(1, 2));
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar(1));
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar<int>(1, 2));
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.Bar(1));
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute[1, 2]);
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute[1]);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substituteFooBarBar[1]);
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substituteFooBarBar.Bar);
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substituteFooBarBar.FooBar());
        }
    }
}";
             ...
             var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(36, 61)
                    }
                },
                new DiagnosticResult
                {
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.GetBar());
            ReturnsExtensions.ReturnsNullForAnyArgs<object>(substitute.GetFooBar());
        }
    }
        ...
        object Foo(object @obj);
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(13, 61)
                    }
                }
            };
