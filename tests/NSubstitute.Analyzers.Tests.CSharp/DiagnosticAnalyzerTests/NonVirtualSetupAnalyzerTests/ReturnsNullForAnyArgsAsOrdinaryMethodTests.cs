    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(18, 53)
                }
            };
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(24, 53)
                }
            };
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar<int>());
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        ...
        {
            Foo substitute = null;
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(), null);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar<int>(1, 2));
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(1));
        }
    }
}";
        ...
        object Foo(object @obj);
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(13, 53)
                    }
                }
            };
