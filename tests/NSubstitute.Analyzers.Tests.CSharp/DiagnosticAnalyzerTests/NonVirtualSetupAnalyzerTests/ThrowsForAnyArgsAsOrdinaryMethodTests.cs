    ...
    {{
        ...
        {{
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(11, 50)
                }
            };
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(25, 50)
                }
            };
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ExceptionExtensions.ThrowsForAnyArgs(substitute.Bar<int>(), new Exception());
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ExceptionExtensions.ThrowsForAnyArgs(substitute.Bar<int>(1, 2), new Exception());
            ExceptionExtensions.ThrowsForAnyArgs(substitute.Bar(1), new Exception());
        }
    }
}";
        ...
        public void Test()
        {
             ...
             var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(37, 50)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(38, 50)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(39, 50)
                    }
                }
            };
        ...
        int Foo(object @obj);
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(14, 50)
                    }
                }
            };
