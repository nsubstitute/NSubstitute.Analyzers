...
{
    public class ReturnsNullAsExtensionMethodWithGenericTypeSpecifiedTests : NonVirtualSetupDiagnosticVerifier
    {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.Bar().ReturnsNull<object>();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            returnValue.ReturnsNull<object>();
        }
    }
}";
            await VerifyNoDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.Bar<int>().ReturnsNull<object>();
        }
    }
}";
            await VerifyNoDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            substitute[1].ReturnsNull<object>();
        }
    }
}";
            await VerifyNoDiagnostic(source);
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        ...
        {
            Foo substitute = null;
            substitute.Bar().ReturnsNull<object>(null);
        }
    }
}";
            await VerifyNoDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar.ReturnsNull<object>();
            substitute.FooBar.ReturnsNull<object>();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar(1, 2).ReturnsNull<object>();
            substitute.Bar(1).ReturnsNull<object>();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar<int>(1, 2).ReturnsNull<object>();
            substitute.Bar(1).ReturnsNull<object>();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute[1, 2].ReturnsNull<object>();
            substitute[1].ReturnsNull<object>();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substituteFooBarBar[1].ReturnsNull<object>();
            substituteFooBarBar.Bar.ReturnsNull<object>();
            substituteFooBarBar.FooBar().ReturnsNull<object>();
        }
    }
}";
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.GetBar().ReturnsNull<object>();
            substitute.GetFooBar().ReturnsNull<object>();
        }
    }
