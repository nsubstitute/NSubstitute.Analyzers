...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar, 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.FooBar, 1);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(1, 2), 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(1), 1);
        }
    }
}";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(24, 57)
                }
            };
            await VerifyDiagnostic(source, expectedDiagnostic);
        }
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar<int>(1, 2), 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(1), 1);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute[1,2], 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute[1], 1);
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.ReturnsForAnyArgs<int>(substituteFooBarBar[1], 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substituteFooBarBar.Bar, 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substituteFooBarBar.FooBar(), 1);
        }
    }
}";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(35, 57)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(36, 57)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(37, 57)
                    }
                }
            };
        ...
        public void Test()
        {
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(39, 57)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(40, 57)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(41, 57)
                    }
                }
            };
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.GetBar(), 1);
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.GetFooBar(), 1);
        }
    }
        ...
        int Foo(object @obj);
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(12, 57)
                    }
                }
            };
