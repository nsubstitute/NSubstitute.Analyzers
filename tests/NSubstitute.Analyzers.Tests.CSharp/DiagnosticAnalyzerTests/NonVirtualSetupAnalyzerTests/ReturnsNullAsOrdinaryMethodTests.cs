    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(18, 43)
                }
            };
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(24, 43)
                }
            };
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            ReturnsExtensions.ReturnsNull(substitute.Bar<int>());
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        ...
        {
            Foo substitute = null;
            ReturnsExtensions.ReturnsNull(substitute.Bar(), null);
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            ReturnsExtensions.ReturnsNull(substitute.Bar<int>(1, 2));
            ReturnsExtensions.ReturnsNull(substitute.Bar(1));
        }
    }
}";
        ...
        public void Test()
        {
             ...
             var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(36, 43)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(37, 43)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(38, 43)
                    }
                }
            };
        ...
        object Foo(object @obj);
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(13, 43)
                    }
                }
            };
