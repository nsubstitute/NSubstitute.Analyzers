...
namespace NSubstitute.Analyzers.Tests.CSharp.DiagnosticAnalyzerTests.NonVirtualSetupWhenAnalyzerTests
{
    ...
    {
        [Theory]
        [InlineData("sub => sub.Bar()", 19, 73)]
        [InlineData("delegate(Foo sub) { sub.Bar(); }", 19, 86)]
        [InlineData("sub => { sub.Bar(); }", 19, 75)]
...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.WhenForAnyArgs<Foo>(substitute, {whenAction}).Do(callInfo => i++);
        }}
    }}
}}";
...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.WhenForAnyArgs<Foo2>(substitute, {whenAction}).Do(callInfo => i++);
        }}
    }}
}}";
            await VerifyDiagnostic(source);
...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.WhenForAnyArgs<Func<int>>(substitute, {whenAction}).Do(callInfo => i++);
        }}
    }}
}}";
            await VerifyDiagnostic(source);
        ...
        [Theory]
        [InlineData("sub => sub.Bar()", 24, 74)]
        [InlineData("delegate(Foo2 sub) { sub.Bar(); }", 24, 88)]
        [InlineData("sub => { sub.Bar(); }", 24, 76)]
...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.WhenForAnyArgs<IFoo>(substitute, {whenAction}).Do(callInfo => i++);
        }}
    }}
}}";
            await VerifyDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.WhenForAnyArgs<IFoo<int>>(substitute, {whenAction}).Do(callInfo => i++);
        }}
    }}
}}";
            await VerifyDiagnostic(source);
...
{{
    ...
    {{
        ...
        {{
            Foo substitute = null;
            SubstituteExtensions.WhenForAnyArgs<Foo>(substitute, {whenAction}, 1);
        }}
    }}
}}";
            await VerifyDiagnostic(source);
        ...
        [Theory]
        [InlineData("sub => { var x = sub.Bar; }", 16, 83)]
        [InlineData("sub => { int x; x = sub.Bar; }", 16, 86)]
        [InlineData("delegate(Foo sub) { var x = sub.Bar; }", 16, 94)]
...
{{
    ...
    {{
        ...
        [Theory]
        [InlineData("sub => { var x = sub[1]; }", 16, 83)]
        [InlineData("delegate(Foo sub) { var x = sub[1]; }", 16, 94)]
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.WhenForAnyArgs<Foo>(substitute, SubstituteCall).Do(callInfo => i++);
            substitute.Bar();
        }
    }
}";
