...
namespace NSubstitute.Analyzers.Tests.CSharp.DiagnosticAnalyzerTests.NonVirtualSetupWhenAnalyzerTests
{
    ...
    {
        [Theory]
        [InlineData("sub => sub.Bar()", 41)]
        [InlineData("delegate(Foo sub) { sub.Bar(); }", 54)]
        [InlineData("sub => { sub.Bar(); }", 43)]
...
{{
    ...
    {{
        ...
        [Theory]
        [InlineData("sub => sub.Bar()", 42)]
        [InlineData("delegate(Foo2 sub) { sub.Bar(); }", 56)]
        [InlineData("sub => { sub.Bar(); }", 44)]
...
{{
    ...
    {{
        ...
        [Theory]
        [InlineData("sub => { var x = sub.Bar; }", 51)]
        [InlineData("delegate(Foo sub) { var x = sub.Bar; }", 62)]
...
{{
    ...
    {{
        ...
        [Theory]
        [InlineData("sub => { var x = sub[1]; }", 51)]
        [InlineData("delegate(Foo sub) { var x = sub[1]; }", 62)]
