...
{
    public class ReturnsAsOrdinaryMethodWithGenericTypeSpecifiedTests : CallInfoDiagnosticVerifier
    {
        [Theory]
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.Returns<int>(substitute.Bar(ref value), callInfo =>
            {
                callInfo[0] = 1;
                return 1;
            });
