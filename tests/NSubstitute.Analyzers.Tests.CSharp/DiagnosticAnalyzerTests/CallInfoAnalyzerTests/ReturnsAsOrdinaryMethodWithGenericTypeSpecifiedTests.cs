...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.Returns<int>(substitute.Bar(Arg.Any<int>()), callInfo =>
            {{
                {argAccess}
                return 1;
            }});
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.Returns<int>(substitute.Bar(Arg.Any<int>(), Arg.Any<int>()), callInfo =>
            {{
                {argAccess}
                return 1;
            }});
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.Returns<int>(substitute.Bar(Arg.Any<int>(), Arg.Any<double>()), callInfo =>
            {{
                {argAccess}
                return 1;
            }});
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.Returns<int>(substitute.Bar(Arg.Any<Bar>()), callInfo =>
            {{
                {argAccess}
                return 1;
            }});
