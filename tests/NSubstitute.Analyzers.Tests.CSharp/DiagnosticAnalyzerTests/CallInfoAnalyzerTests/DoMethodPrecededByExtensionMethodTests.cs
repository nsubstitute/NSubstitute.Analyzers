...
{{
    ...
    {{
        ...
        {{
            ...
            var returnValue = sub.{method}(substitute => {{var _ = {call}; }});
...
{{
    ...
    {{
        ...
        {{
            ...
            substitute.{method}(sub => sub.FooBaz(Arg.Any<int>(), Arg.Any<int>()))
                .Do(outerCallInfo =>
                {{
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<IFooBar>();
            substitute.{method}(sub => sub.FooBaz(Arg.Any<int>())).Do(outerCallInfo =>
            {{
                var otherSubstitute = NSubstitute.Substitute.For<IFoo>();
                otherSubstitute.Bar(Arg.Any<int>()).Returns(innerCallInfo =>
                {{
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<IFooBar>();
            substitute.{method}(sub => sub.FooBaz(Arg.Any<int>(), Arg.Any<int>())).Do(outerCallInfo =>
            {{
                var otherSubstitute = NSubstitute.Substitute.For<IFoo>();
                otherSubstitute.Bar(Arg.Any<int>()).Returns(innerCallInfo =>
                {{
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<IFooBar>();
            substitute.{method}(sub => sub.FooBaz(Arg.Any<string>())).Do(outerCallInfo =>
            {{
                var otherSubstitute = NSubstitute.Substitute.For<IFoo>();
                otherSubstitute.Bar(Arg.Any<int>()).Returns(innerCallInfo =>
                {{
...
{{
    ...
    {{
        ...
        {{
            int value = 0;
            var sub = NSubstitute.Substitute.For<Foo>();
            sub.{method}(substitute => {{var _ = substitute.Bar(ref value); }}).Do(callInfo =>
            {{
                callInfo[0] = 1;
            }});
        }}
...
{{
    ...
    {{
        ...
        {{
            int value = 0;
            var sub = NSubstitute.Substitute.For<Foo>();
            sub.{method}(substitute => {{var _ = substitute.Bar(out value); }}).Do(callInfo =>
            {{
                callInfo[0] = 1;
            }});
        }}
