...
{
    public class ThrowsForAnyArgsAsExtensionMethodTests : CallInfoDiagnosticVerifier
    {
        [Theory]
...
{{
    ...
    {{
        ...
        {{
            ...
            {call}.ThrowsForAnyArgs(callInfo =>
            {{
                {argAccess}
...
{{
    ...
    {{
        ...
        [Theory]
        [InlineData("substitute.Bar(Arg.Any<int>(), Arg.Any<double>())", "callInfo.ArgAt<Bar>(1);", 26, 17)]
        [InlineData("substitute.Bar(Arg.Any<int>(), Arg.Any<double>())", "var x = (Bar)callInfo[1];", 26, 30)]
        [InlineData("substitute.Bar(Arg.Any<int>(), Arg.Any<double>())", "var x = callInfo[1] as Bar;", 26, 25)]
        [InlineData("substitute.Bar(Arg.Any<int>(), Arg.Any<double>())", "var x = (Bar)callInfo.Args()[1];", 26, 30)]
        [InlineData("substitute.Bar(Arg.Any<int>(), Arg.Any<double>())", "var x = callInfo.Args()[1] as Bar;", 26, 25)]
        [InlineData("substitute[Arg.Any<int>(), Arg.Any<double>()]", "callInfo.ArgAt<Bar>(1);", 26, 17)]
        [InlineData("substitute[Arg.Any<int>(), Arg.Any<double>()]", "var x = (Bar)callInfo[1];", 26, 30)]
        [InlineData("substitute[Arg.Any<int>(), Arg.Any<double>()]", "var x = callInfo[1] as Bar;", 26, 25)]
        [InlineData("substitute[Arg.Any<int>(), Arg.Any<double>()]", "var x = (Bar)callInfo.Args()[1];", 26, 30)]
        [InlineData("substitute[Arg.Any<int>(), Arg.Any<double>()]", "var x = callInfo.Args()[1] as Bar;", 26, 25)]
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<Foo>();
            {callInfo}.ThrowsForAnyArgs(callInfo =>
            {{
                {argAccess}
                return new Exception();
            }});
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar(ref value).ThrowsForAnyArgs(callInfo =>
            {
                callInfo[0] = 1;
                return new Exception();
            });
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            substitute.Bar(out value).ThrowsForAnyArgs(callInfo =>
            {
                callInfo[0] = 1;
                return new Exception();
            });
