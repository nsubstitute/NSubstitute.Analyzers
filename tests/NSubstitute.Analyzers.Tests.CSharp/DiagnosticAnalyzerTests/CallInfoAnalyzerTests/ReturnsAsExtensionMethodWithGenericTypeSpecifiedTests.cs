...
{{
    ...
    {{
        ...
        {{
            ...
            returnedValue.Returns<int>(callInfo =>
            {{
                {argAccess}
                return 1;
            }});
...
{{
    ...
    {{
        ...
        {{
            ...
            descriptor.OverrideMessage("There is no argument at position 1");
...
{{
    ...
    {{
        ...
        {{
            ...
            var descriptor = DiagnosticDescriptors<DiagnosticDescriptorsProvider>.CallInfoCouldNotConvertParameterAtPosition;
            descriptor.OverrideMessage(message);
...
{{
    ...
    {{
        ...
        {{
            ...
            var descriptor = DiagnosticDescriptors<DiagnosticDescriptorsProvider>.CallInfoCouldNotConvertParameterAtPosition;
            descriptor.OverrideMessage("Could not set argument 1 (double) as it is not an out or ref argument.");
...
{{
    ...
    {{
        ...
        {{
            ...
            descriptor.OverrideMessage(expectedMessage);
