...
namespace NSubstitute.Analyzers.Tests.CSharp.DiagnosticAnalyzerTests.CallInfoAnalyzerTests
{
    public class ReturnsAsExtensionMethodsTests : CallInfoDiagnosticVerifier
    {
        ...
        public async Task ReportsDiagnostic_WhenAccessingArgumentOutOfBounds(string argAccess, int expectedLine, int expectedColumn)
        {
...
{{
    ...
    {{
        ...
        public async Task ReportsNoDiagnostic_WhenAccessingArgumentWithinBounds(string argAccess)
        {
            var source = $@"using System;
using NSubstitute;
...
{{
    ...
    {{
        ...
        public async Task ReportsDiagnostic_WhenConvertingTypeToUnsupportedType(string argAccess, int expectedLine, int expectedColumn)
        {
            var source = $@"using System;
using NSubstitute;
...
{{
    ...
    {{
        ...
        [Fact]
        public async Task ReportsDiagnostic_WhenAccessingArgumentByTypeNotInInvocation()
        {
            var source = @"using System;
using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsNoDiagnostic_WhenAccessingArgumentByTypeInInInvocation()
        {
            var source = @"using System;
using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsDiagnostic_WhenAccessingArgumentByTypeMultipleTimesInInvocation()
        {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsNoDiagnostic_WhenAccessingArgumentByTypeMultipleDifferentTypesInInvocation()
        {
            var source = @"using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsDiagnostic_WhenAssigningValueToNotOutNorRefArgument()
        {
            var source = @"using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsNoDiagnostic_WhenAssigningValueToRefArgument()
        {
            var source = @"using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsNoDiagnostic_WhenAssigningValueToOutArgument()
        {
            var source = @"using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsDiagnostic_WhenAssigningValueToOutOfBoundsArgument()
        {
            var source = @"using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsDiagnostic_WhenAssigningWrongTypeToArgument()
        {
            var source = @"using NSubstitute;
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        [Fact]
        public async Task ReportsNoDiagnostic_WhenAssigningProperTypeToArgument()
        {
            var source = @"using NSubstitute;
