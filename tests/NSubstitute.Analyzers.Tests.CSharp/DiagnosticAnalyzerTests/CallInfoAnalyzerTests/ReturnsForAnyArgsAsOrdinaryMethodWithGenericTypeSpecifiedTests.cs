...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.ReturnsForAnyArgs<int>({call}, callInfo =>
            {{
                {argAccess}
                return 1;
            }});
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(ref value), callInfo =>
            {
                callInfo[0] = 1;
                return 1;
            });
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(out value), callInfo =>
            {
                callInfo[0] = 1;
                return 1;
            });
