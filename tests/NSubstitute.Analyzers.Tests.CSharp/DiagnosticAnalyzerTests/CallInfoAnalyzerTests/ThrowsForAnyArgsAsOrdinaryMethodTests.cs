...
{
    public class ThrowsForAnyArgsAsOrdinaryMethodTests : CallInfoDiagnosticVerifier
    {
...
{{
    ...
    {{
        ...
        {{
            ...
            ExceptionExtensions.ThrowsForAnyArgs(returnedValue, callInfo =>
            {{
                {argAccess}
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            ExceptionExtensions.ThrowsForAnyArgs(substitute.Bar(ref value), callInfo =>
            {
                callInfo[0] = 1;
                return new Exception();
            });
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            ExceptionExtensions.ThrowsForAnyArgs(substitute.Bar(out value), callInfo =>
            {
                callInfo[0] = 1;
                return new Exception();
            });
