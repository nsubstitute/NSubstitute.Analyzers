...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.Returns(substitute.FooBaz(Arg.Any<int>(), Arg.Any<int>()), 1)
...
{{
    ...
    {{
        ...
        {{
            var substitute = NSubstitute.Substitute.For<IFooBar>();
            SubstituteExtensions.Returns(substitute.FooBaz(Arg.Any<int>()), 1)
                      .{method}(outerCallInfo =>
            {{
                var otherSubstitute = NSubstitute.Substitute.For<IFoo>();
                otherSubstitute.Bar(Arg.Any<int>()).Returns(innerCallInfo =>
...
{{
    ...
    {{
        ...
        {{
            int value = 0;
            var substitute = NSubstitute.Substitute.For<Foo>();
            SubstituteExtensions.Returns(substitute.Bar(ref value), 1).{method}(callInfo =>
            {{
                callInfo[0] = 1;
            }});
