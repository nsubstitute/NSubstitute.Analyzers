...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            {
                "Can not provide constructor arguments when substituting for an interface. Use SubstitutionContext.Current.SubstituteFactory.Create(new[] {typeof(IFoo)},null) instead.",
                "Can not provide constructor arguments when substituting for an interface. Use SubstitutionContext.Current.SubstituteFactory.Create(typesToProxy: new[] {typeof(IFoo)},null) instead.",
                "Can not provide constructor arguments when substituting for an interface. Use SubstitutionContext.Current.SubstituteFactory.Create(constructorArguments: new object[] { 1 },null) instead."
            };
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            var diagnosticMessages = new[]
            {
                "Can not provide constructor arguments when substituting for a delegate. Use SubstitutionContext.Current.SubstituteFactory.Create(new[] {typeof(Func<int>)},null) instead.",
                "Can not provide constructor arguments when substituting for a delegate. Use SubstitutionContext.Current.SubstituteFactory.Create(typesToProxy: new[] {typeof(Func<int>)},null) instead.",
                "Can not provide constructor arguments when substituting for a delegate. Use SubstitutionContext.Current.SubstituteFactory.Create(constructorArguments: new object[] { 1 },null) instead."
            };
            var textParserResult = TextParser.GetSpans(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            var substitute = SubstitutionContext.Current.SubstituteFactory.Create(new[] {typeof(Foo)}, new object[]{ 1, 2 });
            var otherSubstitute = SubstitutionContext.Current.SubstituteFactory.Create(typesToProxy: new[] {typeof(Foo)}, constructorArguments: new object[]{ 1, 2 });
            var yetAnotherSubstitute = SubstitutionContext.Current.SubstituteFactory.Create(constructorArguments: new object[]{ 1, 2 }, typesToProxy: new[] {typeof(Foo)});
        }
    }
}";
