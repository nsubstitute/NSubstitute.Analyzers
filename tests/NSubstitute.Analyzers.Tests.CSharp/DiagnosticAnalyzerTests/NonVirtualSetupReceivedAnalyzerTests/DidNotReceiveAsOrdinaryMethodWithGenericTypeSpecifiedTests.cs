...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.DidNotReceive<Foo>(substitute).Bar();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.DidNotReceive<Foo2>(substitute).Bar();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = SubstituteExtensions.DidNotReceive<IFoo>(substitute).Bar;
        }
    }
}";
            await VerifyDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.DidNotReceive<IFoo<int>>(substitute).Bar<int>();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            var x = SubstituteExtensions.DidNotReceive<Foo>(substitute).Bar;
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = SubstituteExtensions.DidNotReceive<IFoo>(substitute)[1];
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            var x = SubstituteExtensions.DidNotReceive<Foo>(substitute)[1];
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        ...
        {
            Foo substitute = null;
            substitute.DidNotReceive<Foo>(1).Bar();
        }
    }
}";
            await VerifyDiagnostic(source);
