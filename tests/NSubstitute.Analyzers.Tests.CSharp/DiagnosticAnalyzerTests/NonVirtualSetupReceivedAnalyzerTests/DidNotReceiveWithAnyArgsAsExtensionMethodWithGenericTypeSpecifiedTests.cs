...
{
    public class DidNotReceiveWithAnyArgsAsExtensionMethodWithGenericTypeSpecifiedTests : NonVirtualSetupReceivedDiagnosticVerifier
    {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.DidNotReceiveWithAnyArgs<Foo>().Bar();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.DidNotReceiveWithAnyArgs<Foo2>().Bar();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.DidNotReceiveWithAnyArgs<IFoo>().Bar();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = substitute.DidNotReceiveWithAnyArgs<IFoo>().Bar;
        }
    }
}";
            await VerifyDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.DidNotReceiveWithAnyArgs<IFoo<int>>().Bar<int>();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            var x = substitute.DidNotReceiveWithAnyArgs<Foo>().Bar;
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = substitute.DidNotReceiveWithAnyArgs<IFoo>()[1];
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            var x = substitute.DidNotReceiveWithAnyArgs<Foo>()[1];
        }
    }
}";
            await VerifyDiagnostic(source);
