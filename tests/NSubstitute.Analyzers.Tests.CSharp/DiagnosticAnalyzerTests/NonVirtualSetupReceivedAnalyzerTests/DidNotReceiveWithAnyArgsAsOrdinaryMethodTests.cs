...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = SubstituteExtensions.DidNotReceiveWithAnyArgs(substitute).Bar;
        }
    }
}";
            await VerifyNoDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.DidNotReceiveWithAnyArgs(substitute).Bar<int>();
        }
    }
}";
            await VerifyNoDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = SubstituteExtensions.DidNotReceiveWithAnyArgs(substitute)[1];
        }
    }
}";
            await VerifyNoDiagnostic(source);
