...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = SubstituteExtensions.ReceivedWithAnyArgs(substitute).Bar;
        }
    }
}";
            await VerifyDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            SubstituteExtensions.ReceivedWithAnyArgs(substitute).Bar<int>();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = SubstituteExtensions.ReceivedWithAnyArgs(substitute)[1];
        }
    }
}";
            await VerifyDiagnostic(source);
