...
{
    public class ReceivedWithAnyArgsAsExtensionMethodWithGenericTypeSpecifiedTests : NonVirtualSetupReceivedDiagnosticVerifier
    {
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.ReceivedWithAnyArgs<Foo>().Bar();
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.ReceivedWithAnyArgs<Foo2>().Bar();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.ReceivedWithAnyArgs<Func<int>>()();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = substitute.ReceivedWithAnyArgs<IFoo>().Bar;
        }
    }
}";
            await VerifyDiagnostic(source);
   ...
   public interface IFoo<T>
    ...
    public class FooTests
    {
        public void Test()
        {
            ...
            substitute.ReceivedWithAnyArgs<IFoo<int>>().Bar<int>();
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            var x = substitute.ReceivedWithAnyArgs<Foo>().Bar;
        }
    }
}";
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<IFoo>();
            var x = substitute.ReceivedWithAnyArgs<IFoo>()[1];
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = NSubstitute.Substitute.For<Foo>();
            var x = substitute.ReceivedWithAnyArgs<Foo>()[1];
        }
    }
}";
            await VerifyDiagnostic(source);
...
namespace NSubstitute
{
    ...
    public class FooTests
    {
        ...
        {
            Foo substitute = null;
            substitute.ReceivedWithAnyArgs(1m).Bar();
        }
    }
}";
            await VerifyDiagnostic(source);
