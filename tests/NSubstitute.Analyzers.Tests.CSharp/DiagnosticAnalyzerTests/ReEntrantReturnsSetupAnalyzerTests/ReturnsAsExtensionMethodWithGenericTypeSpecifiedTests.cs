...
{
    public class ReturnsAsExtensionMethodWithGenericTypeSpecifiedTests : ReEntrantReturnsSetupDiagnosticVerifier
    {
...
{{
    ...
    {{
        ...
        {{
            ...
            substitute.Bar().Returns<int>(ReturnThis(), OtherReturn());
        }}
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = Substitute.For<IBar>();
            substitute.Foo().Returns<int>(NestedReturnThis());
            return 1;
        }
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = Substitute.For<IFoo>();
            substitute.Bar().Returns<int>(x => ReturnThis());
        }
...
{{
    ...
    {{
        ...
        {{
            {localVariable}
            var substitute = Substitute.For<IFoo>();
            substitute.Bar().Returns<IBar>(bar);
        }}
...
{{
    ...
    {{
        ...
        {{
            var substitute = Substitute.For<IFoo>();
            substitute.Bar().Returns<int>({rootCall});
        }}
...
{{
    ...
    {{
        ...
        {{
            var substitute = Substitute.For<IFoo>();
            substitute.Bar().Returns<int>({firstReturn}, {secondReturn});
        }}
