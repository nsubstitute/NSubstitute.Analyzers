...
{{
    ...
    {{
        ...
        {{
            ...
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(), ReturnThis(), OtherReturn());
        }}
        ...
        {{
            ...
            var firstArgumentDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(20, 75)
                }
            };
            ...
            var secondArgumentDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(20, 89)
                }
            };
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = Substitute.For<IBar>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Foo(), NestedReturnThis());
            return 1;
        }
        ...
        private int OtherNestedReturnThis()
        {
            ...
            SubstituteExtensions.ReturnsForAnyArgs<int>(sub.Foo(), 1);
            return 1;
        }
    }
}";
            ...
            var nestedArgumentDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(31, 75)
                }
            };
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = Substitute.For<IFoo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(), x => ReturnThis());
        }
...
{{
    ...
    {{
        ...
        {{
            {localVariable}
            var substitute = Substitute.For<IFoo>();
            SubstituteExtensions.ReturnsForAnyArgs<IBar>(substitute.Bar(), bar);
        }}
...
{{
    ...
    {{
        ...
        {{
            var substitute = Substitute.For<IFoo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(), {rootCall});
        }}
...
{{
    ...
    {{
        ...
        {{
            var substitute = Substitute.For<IFoo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(), {firstReturn}, {secondReturn});
        }}
...
namespace MyNamespace
{
    ...
    public class FooTests
    {
        ...
        {
            var substitute = Substitute.For<IFoo>();
            SubstituteExtensions.ReturnsForAnyArgs<int>(substitute.Bar(), FooBar.ReturnThis());
        }
    }
}";
