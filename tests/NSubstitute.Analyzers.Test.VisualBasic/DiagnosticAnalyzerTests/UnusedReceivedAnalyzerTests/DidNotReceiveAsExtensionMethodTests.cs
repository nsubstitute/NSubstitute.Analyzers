...
{
    public class DidNotReceiveAsExtensionMethodTests : DiagnosticAnalyzerTests.UnusedReceivedAnalyzerTests.UnusedReceivedAnalyzerTests
    {
        [Fact]
