...
{
    public class ReceivedWithAnyArgsAsOrdinaryMethodWithGenericTypeSpecifiedTests : DiagnosticAnalyzerTests.UnusedReceivedAnalyzerTests.UnusedReceivedAnalyzerTests
    {
          [Fact]
