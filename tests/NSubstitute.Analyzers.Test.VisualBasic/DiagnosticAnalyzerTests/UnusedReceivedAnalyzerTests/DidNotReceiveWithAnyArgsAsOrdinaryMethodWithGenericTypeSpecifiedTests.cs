...
{
    public class DidNotReceiveWithAnyArgsAsOrdinaryMethodWithGenericTypeSpecifiedTests : DiagnosticAnalyzerTests.UnusedReceivedAnalyzerTests.UnusedReceivedAnalyzerTests
    {
          [Fact]
