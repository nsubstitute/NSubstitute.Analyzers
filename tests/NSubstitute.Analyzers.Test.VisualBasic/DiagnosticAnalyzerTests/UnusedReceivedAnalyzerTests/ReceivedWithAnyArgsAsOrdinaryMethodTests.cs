...
{
    public class ReceivedWithAnyArgsAsOrdinaryMethodTests : DiagnosticAnalyzerTests.UnusedReceivedAnalyzerTests.UnusedReceivedAnalyzerTests
    {
         [Fact]
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim bar = SubstituteExtensions.ReceivedWithAnyArgs(substitute).Bar
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim bar = SubstituteExtensions.ReceivedWithAnyArgs(substitute)(0)
        End Sub
    End Class
End Namespace
";
...
Namespace NSubstitute
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Func(Of Integer))()
            SubstituteExtensions.ReceivedWithAnyArgs(substitute, 1D)
        End Sub
    End Class
End Namespace
";
