...
namespace NSubstitute.Analyzers.Tests.VisualBasic.DiagnosticAnalyzersTests.NonVirtualSetupWhenAnalyzerTests
{
    ...
    {
        [Theory]
        [InlineData("Sub(sb) sb.Bar()", 14, 66)]
        [InlineData(@"Function(ByVal [sub] As Foo) [sub].Bar()", 14, 87)]
        [InlineData(
            @"Sub(sb As Foo)
                sb.Bar()
            End Sub",
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.When(Of Foo)(substitute,{whenAction}).[Do](Sub(callInfo) i = i + 1)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.When(Of Foo2)(substitute,{whenAction}).[Do](Sub(callInfo) i = i + 1)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.When(Of Func(Of Integer))(substitute,{whenAction}).[Do](Sub(callInfo) i = i + 1)
        End Sub
    End Class
End Namespace
";
        ...
        [Theory]
        [InlineData("Sub(sb) sb.Bar()", 22, 67)]
        [InlineData(@"Function(ByVal [sub] As Foo2) [sub].Bar()", 22, 89)]
        [InlineData(
            @"Sub(sb As Foo2)
                sb.Bar()
            End Sub",
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.When(Of IFoo)(substitute,{whenAction}).[Do](Sub(callInfo) i = i +1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Sub Test()
            ...
            SubstituteExtensions.When(Of IFoo (Of Integer))(substitute,{whenAction}).[Do](Sub(callInfo) i = i + 1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace NSubstitute
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.[When](Of Foo)(substitute, {whenAction}, 1)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim i As Integer = 0
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.When(Of Foo)(substitute,AddressOf SubstituteCall).[Do](Sub(callInfo) i = i + 1)
            substitute.Bar()
        End Sub
