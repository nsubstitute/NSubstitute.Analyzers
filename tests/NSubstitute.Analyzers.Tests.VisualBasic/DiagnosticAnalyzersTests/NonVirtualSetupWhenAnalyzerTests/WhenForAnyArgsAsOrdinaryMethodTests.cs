...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.WhenForAnyArgs(substitute,{whenAction}).[Do](Sub(callInfo) i = i + 1)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim i As Integer = 0
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.WhenForAnyArgs(substitute,AddressOf SubstituteCall).[Do](Sub(callInfo) i = i + 1)
            substitute.Bar()
        End Sub
