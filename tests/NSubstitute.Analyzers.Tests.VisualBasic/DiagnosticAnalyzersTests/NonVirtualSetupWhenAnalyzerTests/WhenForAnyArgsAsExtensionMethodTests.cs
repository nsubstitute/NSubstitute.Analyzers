...
namespace NSubstitute.Analyzers.Tests.VisualBasic.DiagnosticAnalyzersTests.NonVirtualSetupWhenAnalyzerTests
{
    ...
    {
        [Theory]
        [InlineData("Sub(sb) sb.Bar()", 14, 47)]
        [InlineData(@"Function(ByVal [sub] As Foo) [sub].Bar()", 14, 68)]
        [InlineData(
            @"Sub(sb As Foo)
                sb.Bar()
            End Sub",
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            substitute.WhenForAnyArgs({whenAction}).[Do](Sub(callInfo) i = i + 1)
        End Sub
    End Class
End Namespace
";
...
";
        ...
        [Theory]
        [InlineData("Sub(sb) sb.Bar()", 22, 47)]
        [InlineData(@"Function(ByVal [sub] As Foo2) [sub].Bar()", 22, 69)]
        [InlineData(
            @"Sub(sb As Foo2)
                sb.Bar()
            End Sub",
...
Namespace NSubstitute
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            substitute.WhenForAnyArgs({whenAction}, 1)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim i As Integer = 0
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            substitute.WhenForAnyArgs(AddressOf SubstituteCall).[Do](Sub(callInfo) i = i + 1)
            substitute.Bar()
        End Sub
