...
{
    public class ReceivedWithAnyArgsAsOrdinaryMethodTests : NonVirtualSetupReceivedDiagnosticVerifier
    {
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim x As Integer = SubstituteExtensions.ReceivedWithAnyArgs(substitute).Bar
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.ReceivedWithAnyArgs(substitute).Bar(Of Integer)
        End Sub
    End Class
End Namespace";
            await VerifyNoDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            Dim x As Integer = SubstituteExtensions.ReceivedWithAnyArgs(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyNoDiagnostic(source);
