...
{
    public class DidNotReceiveAsOrdinaryMethodWithGenericTypeSpecifiedTests : NonVirtualSetupReceivedDiagnosticVerifier
    {
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.DidNotReceive(Of Foo)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.DidNotReceive(Of Foo2)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.DidNotReceive(Of IFoo)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim x As Integer = SubstituteExtensions.DidNotReceive(Of IFoo)(substitute).Bar
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.DidNotReceive(Of IFoo(Of Integer))(substitute).Bar(Of Integer)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            Dim x As Integer = SubstituteExtensions.DidNotReceive(Of Foo)(substitute).Bar
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            Dim x As Integer = SubstituteExtensions.DidNotReceive(Of IFoo)(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            Dim x As Integer = SubstituteExtensions.DidNotReceive(Of Foo)(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace NSubstitute
    ...
    Module SubstituteExtensions
        <Extension>
        Function DidNotReceive(Of T)(ByVal returnValue As T) As T
            Return Nothing
        End Function
    End Module
