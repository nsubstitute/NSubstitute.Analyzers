...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.Received(Of Foo)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.Received(Of Foo2)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.Received(Of IFoo)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim x As Integer = SubstituteExtensions.Received(Of IFoo)(substitute).Bar
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.Received(Of IFoo(Of Integer))(substitute).Bar(Of Integer)
        End Sub
    End Class
End Namespace";
            await VerifyNoDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            Dim x As Integer = SubstituteExtensions.Received(Of Foo)(substitute).Bar
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            Dim x As Integer = SubstituteExtensions.Received(Of IFoo)(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyNoDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            Dim x As Integer = SubstituteExtensions.Received(Of Foo)(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyNoDiagnostic(source);
