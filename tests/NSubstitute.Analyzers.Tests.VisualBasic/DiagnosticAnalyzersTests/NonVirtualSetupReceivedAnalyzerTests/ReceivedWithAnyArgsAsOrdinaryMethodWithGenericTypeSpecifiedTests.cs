...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.ReceivedWithAnyArgs(Of Foo)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.ReceivedWithAnyArgs(Of Foo2)(substitute).Bar()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim x As Integer = SubstituteExtensions.ReceivedWithAnyArgs(Of IFoo)(substitute).Bar
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            SubstituteExtensions.ReceivedWithAnyArgs(Of IFoo(Of Integer))(substitute).Bar(Of Integer)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            Dim x As Integer = SubstituteExtensions.ReceivedWithAnyArgs(Of Foo)(substitute).Bar
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            Dim x As Integer = SubstituteExtensions.ReceivedWithAnyArgs(Of IFoo)(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            Dim x As Integer = SubstituteExtensions.ReceivedWithAnyArgs(Of Foo)(substitute)(1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace NSubstitute
    ...
    Module SubstituteExtensions
        <Extension>
        Function ReceivedWithAnyArgs(Of T)(ByVal returnValue As T) As T
            Return Nothing
        End Function
    End Module
