...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            Dim x As Integer = substitute.DidNotReceiveWithAnyArgs().Bar
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            substitute.DidNotReceiveWithAnyArgs().Bar(Of Integer)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            Dim x As Integer = substitute.DidNotReceiveWithAnyArgs()(1)
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace NSubstitute
    ...
    Module SubstituteExtensions
        <Extension>
        Function DidNotReceiveWithAnyArgs(Of T)(ByVal returnValue As T, ByVal x as Integer) As T
            Return Nothing
        End Function
    End Module
