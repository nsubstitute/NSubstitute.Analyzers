...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            substitute.FooBaz(Arg.Any(Of Integer)(), Arg.Any(Of Integer)()).Returns(1).{method}(Function(outerCallInfo)
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFooBar)()
            substitute.FooBaz(Arg.Any(Of String)()).Returns(1).{method}(Function(outerCallInfo)
                Dim otherSubstitute = NSubstitute.Substitute.[For](Of IFoo)()
                otherSubstitute.Bar(Arg.Any(Of Integer)()).Returns(Function(innerCallInfo)
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            substitute.Bar(value).Returns(1).{method}(Function(callInfo)
                                              callInfo(0) = 1
                                          End Function)
        End Sub
    End Class
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFooBar)()
            substitute.FooBaz(Arg.Any(Of Integer)()).Returns(1).{method}(Function(outerCallInfo)
                Dim otherSubstitute = NSubstitute.Substitute.[For](Of IFoo)()
                otherSubstitute.Bar(Arg.Any(Of Integer)()).Returns(Function(innerCallInfo)
                    Dim x = [|outerCallInfo.Arg(Of String)()|]
