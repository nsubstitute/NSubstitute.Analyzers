...
public abstract class CallInfoDiagnosticVerifier : VisualBasicDiagnosticVerifier, ICallInfoDiagnosticVerifier
{
    ...
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo(1)")]
    ...
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.Args()(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.Args()(1)")]
    ...
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(1)")]
    ...
    [InlineData("substitute(Arg.Any(Of Integer)())", "Dim x = callInfo(1)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "state = callInfo(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "state = callInfo(1)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "Dim x = callInfo.Args()(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "Dim x = callInfo.Args()(1)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "state = callInfo.Args()(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "state = callInfo.Args()(1)")]
    ...
    [InlineData("substitute(Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(0)")]
    [InlineData("substitute(Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(1)")]
    ...
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo(1)")]
    ...
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.Args()(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.Args()(1)")]
    ...
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(1)")]
    ...
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "Dim x = callInfo(1)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "state = callInfo(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "state = callInfo(1)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "Dim x = callInfo.Args()(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "Dim x = callInfo.Args()(1)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "state = callInfo.Args()(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "state = callInfo.Args()(1)")]
    ...
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(0)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)())", "state = callInfo.ArgTypes()(1)")]
    ...
    [CombinatoryTheory]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = 1")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = DirectCast(1, Object)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = TryCast(1, Object)")]
    [InlineData("substitute.Bar(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = CType(1, Object)")]
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = 1")]
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = DirectCast(1, Object)")]
    [InlineData("substitute(Arg.Any(Of Integer)(), Arg.Any(Of Double)())", "[|callInfo(1)|] = TryCast(1, Object)")]
