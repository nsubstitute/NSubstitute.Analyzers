...
Namespace MyNamespace
    Interface Foo
        Function Bar(ByVal x As Integer) As Task(Of Integer)
        Property Barr As Task(Of Integer)
        Default Property Item(ByVal x As Integer) As Task(Of Integer)
    End Interface
...
Namespace MyNamespace
    Interface Foo
        ...
        Default Property Item(ByVal x As Integer, ByVal Optional y As Integer = 1) As Task(Of Integer)
    End Interface
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            substitute.FooBaz(Arg.Any(Of Integer)(), Arg.Any(Of Integer)()).{method}(Function(outerCallInfo)
                Dim otherSubstitute = NSubstitute.Substitute.[For](Of IFoo)()
                otherSubstitute.Bar(Arg.Any (Of Integer)()).{method}(Function(innerCallInfo)
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFooBar)()
            substitute.FooBaz(Arg.Any (Of String)()).{method}(Function(outerCallInfo)
                Dim otherSubstitute = NSubstitute.Substitute.[For](Of IFoo)()
                otherSubstitute.Bar(Arg.Any(Of Integer)()).{method}(Function(innerCallInfo)
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of IFooBar)()
            substitute.FooBaz(Arg.Any(Of Integer)()).{method}(Function(outerCallInfo)
                Dim otherSubstitute = NSubstitute.Substitute.[For](Of IFoo)()
                otherSubstitute.Bar(Arg.Any(Of Integer)()).{method}(Function(innerCallInfo)
                    Dim x = [|outerCallInfo.Arg(Of String)()|]
