...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.Returns(returnedValue, Function(callInfo)
                               {argAccess}
                               Return 1
                           End Function)
        End Sub
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.Returns({call}, Function(callInfo)
                               {argAccess}
                               Return 1
                           End Function)
        End Sub
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.Returns(substitute.Bar(value), Function(callInfo)
                                              callInfo(0) = 1
                                              Return 1
                                          End Function)
        End Sub
