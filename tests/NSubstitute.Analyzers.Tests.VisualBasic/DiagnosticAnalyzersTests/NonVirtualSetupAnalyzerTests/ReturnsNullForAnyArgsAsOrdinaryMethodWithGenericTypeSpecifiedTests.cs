...
{
    public class ReturnsNullForAnyArgsAsOrdinaryMethodWithGenericTypeSpecifiedTests : NonVirtualSetupDiagnosticVerifier
    {
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar())
        End Sub
    End Class
End Namespace
";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(16, 61)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(Foo.Bar())
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(returnValue)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute())
        End Sub
    End Class
End Namespace
";
...
";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(25, 61)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of IFoo)(substitute.Bar())
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute.Bar(Of Integer))
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            ReturnsExtensions.ReturnsNullForAnyArgs(Of IFoo)(substitute(1))
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
End Namespace";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(17, 61)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of Foo)
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute(1))
        End Sub
    End Class
End Namespace";
...
End Namespace";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(20, 61)
                }
            };
...
Namespace NSubstitute
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar(), Nothing)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar)
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.FooBar)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute.Bar)
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute.FooBar)
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(14, 66)
                }
            };
            await VerifyDiagnostic(source, expectedDiagnostic);
        }
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar(1))
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(19, 61)
                }
            };
            await VerifyDiagnostic(source, expectedDiagnostic);
        }
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar(Of Integer)(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute.Bar(1))
        End Sub
    End Class
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substitute(1))
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(23, 61)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute(1))
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(23, 66)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substituteFooBarBar(1))
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substituteFooBarBar.Bar)
            ReturnsExtensions.ReturnsNullForAnyArgs(Of Foo)(substituteFooBarBar.FooBar())
        End Sub
    End Class
End Namespace
";
             ...
             var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(40, 61)
                    }
                },
                new DiagnosticResult
                {
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substituteFooBarBar(1))
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substituteFooBarBar.Bar)
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substituteFooBarBar.FooBar())
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(40, 66)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(41, 66)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(42, 66)
                    }
                }
            };
...
Namespace MyNamespace
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute.GetBar())
            ReturnsExtensions.ReturnsNullForAnyArgs(Of FooTests)(substitute.GetFooBar())
        End Sub
    End Class
...
End Namespace";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(10, 66)
                    }
                }
            };
