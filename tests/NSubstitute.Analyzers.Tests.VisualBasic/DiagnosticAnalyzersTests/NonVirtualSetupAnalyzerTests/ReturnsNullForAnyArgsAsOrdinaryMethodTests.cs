...
{
    public class ReturnsNullForAnyArgsAsOrdinaryMethodTests : NonVirtualSetupDiagnosticVerifier
    {
...
";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(16, 53)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ReturnsExtensions.ReturnsNullForAnyArgs(Foo.Bar())
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(returnValue)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute())
        End Sub
    End Class
End Namespace
";
...
";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(25, 53)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(Of Integer))
        End Sub
    End Class
End Namespace";
...
End Namespace";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(17, 53)
                }
            };
...
Namespace NSubstitute
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(), Nothing)
        End Sub
    End Class
End Namespace
";
...
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(14, 53)
                }
            };
            await VerifyDiagnostic(source, expectedDiagnostic);
        }
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(1))
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(19, 53)
                }
            };
            await VerifyDiagnostic(source, expectedDiagnostic);
        }
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(Of Integer)(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.Bar(1))
        End Sub
    End Class
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute(1, 2))
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute(1))
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(23, 53)
                }
            };
...
";
             ...
             var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(40, 53)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(41, 53)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(42, 53)
                    }
                }
            };
...
";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(43, 53)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(44, 53)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(45, 53)
                    }
                }
            };
...
Namespace MyNamespace
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.GetBar())
            ReturnsExtensions.ReturnsNullForAnyArgs(substitute.GetFooBar())
        End Sub
    End Class
...
End Namespace";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(10, 53)
                    }
                }
            };
