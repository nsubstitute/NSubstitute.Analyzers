...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.Returns(Of Integer)(substitute.Bar, 1)
            SubstituteExtensions.Returns(Of Integer)(substitute.FooBar, 1)
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(13, 54)
                }
            };
            await VerifyDiagnostic(source, expectedDiagnostic);
        }
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.Returns(Of Integer)(substitute.Bar(1, 2), 1)
            SubstituteExtensions.Returns(Of Integer)(substitute.Bar(1), 1)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.Returns(Of Integer)(substitute.Bar(Of Integer)(1, 2), 1)
            SubstituteExtensions.Returns(Of Integer)(substitute.Bar(1), 1)
        End Sub
    End Class
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            SubstituteExtensions.Returns(Of Integer)(substitute(1 ,2), 1)
            SubstituteExtensions.Returns(Of Integer)(substitute(1), 1)
        End Sub
    End Class
End Namespace
";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(22, 54)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            SubstituteExtensions.Returns(Of Integer)(substituteFooBarBar(1), 1)
            SubstituteExtensions.Returns(Of Integer)(substituteFooBarBar.Bar, 1)
            SubstituteExtensions.Returns(Of Integer)(substituteFooBarBar.FooBar(), 1)
        End Sub
    End Class
End Namespace
";
             ...
             var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(39, 54)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(40, 54)
                    }
                },
                new DiagnosticResult
                {
...
Namespace MyNamespace
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            SubstituteExtensions.Returns(Of Integer)(substitute.GetBar(), 1)
            SubstituteExtensions.Returns(Of Integer)(substitute.GetFooBar(), 1)
        End Sub
    End Class
...
End Namespace";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(10, 54)
                    }
                }
            };
