...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.Bar())
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)({literal})
        End Sub
    End Class
End Namespace
";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(9, 64)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(Foo.Bar())
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(returnValue)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute())
        End Sub
    End Class
End Namespace
";
...
";
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(26, 64)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.Bar(Of Integer))
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute(1))
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
End Namespace";
            ...
            var expectedDiagnostic = new DiagnosticResult
            {
                ...
                Locations = new[]
                {
                    new DiagnosticResultLocation(20, 64)
                }
            };
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.Bar)
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.FooBar)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.Bar(1, 2))
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.Bar(1))
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute(1 ,2))
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute(1))
        End Sub
    End Class
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substituteFooBarBar(1))
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substituteFooBarBar.Bar)
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substituteFooBarBar.FooBar())
        End Sub
    End Class
End Namespace
";
...
";
            ...
            var expectedDiagnostic = new[]
            {
                ...
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(45, 64)
                    }
                },
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(46, 64)
                    }
                }
            };
...
Namespace MyNamespace
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.GetBar())
            ExceptionExtensions.ThrowsForAnyArgs(Of Exception)(substitute.GetFooBar())
        End Sub
    End Class
...
End Namespace";
            ...
            var expectedDiagnostic = new[]
            {
                new DiagnosticResult
                {
                    ...
                    Locations = new[]
                    {
                        new DiagnosticResultLocation(12, 64)
                    }
                }
            };
