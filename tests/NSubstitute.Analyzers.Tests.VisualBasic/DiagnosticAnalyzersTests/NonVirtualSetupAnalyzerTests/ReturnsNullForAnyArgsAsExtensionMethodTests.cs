...
{
    public class ReturnsNullForAnyArgsAsExtensionMethodTests : NonVirtualSetupDiagnosticVerifier
    {
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            substitute.Bar().ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            returnValue.ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            substitute().ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            ...
            substitute.Bar(Of Integer).ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        ...
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.For(Of IFoo)
            substitute(1).ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace";
            await VerifyDiagnostic(source);
...
Namespace NSubstitute
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            substitute.Bar().ReturnsNullForAnyArgs(Nothing)
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            substitute.Bar.ReturnsNullForAnyArgs()
            substitute.FooBar.ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            substitute.Bar(1, 2).ReturnsNullForAnyArgs()
            substitute.Bar(1).ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            substitute.Bar(Of Integer)(1, 2).ReturnsNullForAnyArgs()
            substitute.Bar(1).ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            Dim substitute = NSubstitute.Substitute.[For](Of Foo)()
            substitute(1, 2).ReturnsNullForAnyArgs()
            substitute(1).ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            substituteFooBarBar(1).ReturnsNullForAnyArgs()
            substituteFooBarBar.Bar.ReturnsNullForAnyArgs()
            substituteFooBarBar.FooBar().ReturnsNullForAnyArgs()
        End Sub
    End Class
End Namespace
";
...
Namespace MyNamespace
    Public Class FooTests
        Public Sub Test()
            ...
            Dim substitute = NSubstitute.Substitute.[For](Of IFoo)()
            substitute.GetBar().ReturnsNullForAnyArgs()
            substitute.GetFooBar().ReturnsNullForAnyArgs()
        End Sub
    End Class
