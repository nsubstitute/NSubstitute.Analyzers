    ...
    Namespace MyInnerNamespace
        ...
        Public Class FooTests
            Public Sub Test()
                ...
                Dim otherSubstitute = SubstitutionContext.Current.SubstituteFactory.CreatePartial(typesToProxy:= {GetType(Foo)}, constructorArguments:= Nothing)
                Dim yetAnotherSubstitute = SubstitutionContext.Current.SubstituteFactory.CreatePartial(constructorArguments:= Nothing, typesToProxy:= {GetType(Foo)})
            End Sub
        End Class
    End Namespace
End Namespace
...
Namespace MyNamespace
    ...
    Public Class FooTests
        Public Sub Test()
            ...
            Dim otherSubstitute = SubstitutionContext.Current.SubstituteFactory.CreatePartial(typesToProxy:= {GetType(Foo.Bar)}, constructorArguments:= Nothing)
            Dim yetAnotherSubstitute = SubstitutionContext.Current.SubstituteFactory.CreatePartial(constructorArguments:= Nothing, typesToProxy:= {GetType(Foo.Bar)})
        End Sub
    End Class
End Namespace
";
